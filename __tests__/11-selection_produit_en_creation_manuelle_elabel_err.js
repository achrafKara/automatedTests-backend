...
describe.each([
    ...
    ['Edge', capEdge],
    ['FireFox', capFirefox],
])(`Sélection du produit en création manuelle de Elabel messages d'erreur`, (browser, cap) => {
    let driver;
    ...
    it(`On ${browser}: an alert with error message should pop up when clicking on next without choosing a field`, async () => {
        try {
